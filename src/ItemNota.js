...
export default function ItemNota(props) {
    ...
    const cardClass = importante 
        ? `bg-red-400 text-white p-4 m-2 rounded-md w-56 h-56 flex flex-col justify-between transform shadow-lg cursor-pointer`
        : `bg-yellow-200 text-gray-800 p-4 m-2 rounded-md w-56 h-56 flex flex-col justify-between transform shadow-lg cursor-pointer`;
